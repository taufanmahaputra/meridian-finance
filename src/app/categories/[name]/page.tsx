  ...
  return (
    <>
      ...
      <div className="p-4 sm:p-7 max-w-[1000px]">
        <Link
          href="/budget"
          className="inline-flex items-center gap-2 px-3.5 py-2 mb-5 rounded-lg text-[13px] font-semibold text-gray-600 bg-white border border-gray-200 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-900 transition-colors"
        >
          <ArrowLeft className="w-4 h-4" /> {t('categoryDetail.back')}
        </Link>

        <div className="flex items-center gap-4 mb-6 flex-wrap rounded-2xl border border-gray-200 bg-white p-5">
